...
# nohup bash val_dnabert_hop_pretrain.sh > val3.out 2>&1 &


python val2.py \
  --model_name_or_path "/projects/p32301/DNABERT/models/ckpt_recv/outEff/checkpoint-50000" \
  ...
  --do_eval \
  --output_dir "/projects/p32301/DNABERT/FT/validate/output/dnabert2_pretrain_out_50K" \
