...
python validate_mlm.py \
  --model_name_or_path "/projects/p32301/DNABERT/models/dnabert2_pretrain_vanilla_200k/checkpoint-200000" \
  ...
  --do_eval \
  --output_dir "/projects/p32301/DNABERT/FT/validate/output/dnabert2_pretrain_out_200K" \
  ...
  --fp16 \
  --run_name "vanilla_dnabert2_val_200K" 
