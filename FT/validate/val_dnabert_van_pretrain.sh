...
# nohup bash val_dnabert_van_pretrain.sh > val.out 2>&1 &

python val.py \
  --model_name_or_path "/projects/p32301/DNABERT/models/ckpt_recv/vanilla/checkpoint-50000" \
  ...
  --do_eval \
  --output_dir "/projects/p32301/DNABERT/FT/validate/output/dnabert2_pretrain_van_50K" \
  ...
  --fp16 \
  --run_name "vanilla_dnabert2_val_50K" 
