...
class Q8bitBertSelfAttentionWithExtras(nn.Module):
    def __init__(
        self,
        config,
        position_embedding_type=None,
        ...
        self.query = Linear8bitLt(config.hidden_size, self.all_head_size)
        self.key = Linear8bitLt(config.hidden_size, self.all_head_size)
        self.value = Linear8bitLt(config.hidden_size, self.all_head_size)
...
class Q4bitBertSelfAttentionWithExtras(nn.Module):
    def __init__(
        self,
        config,
        position_embedding_type=None,
        ...
        self.query = Linear4bit(config.hidden_size, self.all_head_size)
        self.key = Linear4bit(config.hidden_size, self.all_head_size)
        self.value = Linear4bit(config.hidden_size, self.all_head_size)
