...
class QuantBertEmbeddings(QuantizedModule):
...
class QuantizedBertModel(QuantizedModel, ModuleUtilsMixin):
    ...
    def __init__(self, org_model, **quant_params):
        ...
        self.encoder = QuantizedBertEncoder(org_model.encoder, **quant_params)
        self.pooler = (
...
class QuantizedBertOnlyMLMHead(QuantizedModel):

    def __init__(self, org_model, **quant_params):
        super().__init__()
        self.predictions = QuantizedBertLMPredictionHead(org_model.predictions,
                                                         **quant_params)
