...
lora_ckpt=output_out200_Lora_double
lora_folder=out200_dnabert2_Lora_double
...
lora_ckpt_dir=/scratch/hlv8980/Lora_result
...
output_base_dir="/scratch/hlv8980/outlier_test/validate_lora"

for checkpoint in "${checkpoints[@]}"; do
    export lora="${lora_ckpt_dir}/${lora_ckpt}/${lora_folder}_${checkpoint}"
    accelerate launch --config_file accelerate_configs/1gpu_no_mp.yaml validate_lora.py \
    --seed 3000 \
