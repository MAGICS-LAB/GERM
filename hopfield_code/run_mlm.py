...
from softmax import SOFTMAX_MAPPING
...
def main():
    ...
    if model_args.model_name_or_path is not None and AttentionGateType.none.name != "none":
        state_dict = torch.load(str(Path(model_args.model_name_or_path) / "pytorch_model.bin"))
        new_state_dict = {}
    ...
    if len(tokenizer) > embedding_size:
        print("Resizing token embeddings from {} to {}".format(embedding_size, len(tokenizer)))
