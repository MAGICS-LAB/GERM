...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Whether distinct lines of text in the dataset are to be handled as distinct "
            "samples."
        ),
    )
    parser.add_argument(
        "--trust_remote_code",
        action="store_true",
        help="If passed, will trust remote code (e.g. from huggingface.co) and not require local code to be used.",
    )
    parser.add_argument(
        "--block_size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a validation file. If not provided, the validation set will be split from the training set.",
    )
    parser.add_argument(
        "--train_file",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Name of the dataset to use. If not provided, the dataset will be downloaded.",
    )
    parser.add_argument(
        "--data_cache_dir",
        type=str,
