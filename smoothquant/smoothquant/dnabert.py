...
class Int8BertUnpadSelfAttention(nn.Module):
    ...
    def __init__(self, 
        ...
        self.attention_head_size = int(self.embed_dim /
        ...
        self.Wqkv = W8A8B8O8Linear(self.all_head_size, 3 * config.hidden_size)
    ...
    def from_float(
        ...
        int8_module = Int8BertUnpadSelfAttention(module.embed_dim, module.num_heads)
        # Fuse the scaling into the q_proj output scale
        
        int8_module.Wqkv = W8A8B8O8Linear.from_float(
            module.Wqkv, input_scale, q_output_scale
        )
